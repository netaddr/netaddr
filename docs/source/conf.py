...
project = 'netaddr'
copyright = 'Copyright (c) 2008 by David P. D. Moss, 2020 netaddr contributors. All rights reserved.'
...
latex_documents = [
    ('index', 'netaddr.tex', 'netaddr Documentation', 'David P. D. Moss', 'manual'),
]
...
man_pages = [('index', 'netaddr', 'netaddr Documentation', ['David P. D. Moss'], 1)]
